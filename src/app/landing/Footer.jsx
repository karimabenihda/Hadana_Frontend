...
const Footer = () => {
    return (
        <footer className="bg-[#FFC740] px-6 pt-8 md:px-16 lg:px-36 w-full text-white">
            <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500 pb-10">
                <div className="md:max-w-96 ">
               <img src="/images/logo/logo.png" alt='elan' className='h-14 -ml-4'/>
                    <p className="mt-4 text-sm">
Discover stylish and comfortable furniture to make your house feel like home. From cozy sofas to elegant dining sets, we bring quality and design together for every corner of your living space.                    </p>
                ...
                <div className="flex-1 flex items-start md:justify-end gap-20 md:gap-40">
                    ...
                    <div>
                        ...
                        <div className="text-sm space-y-2">
                            <p>+1-234-567-890</p>
                            <p>contact@hadana.com</p>
                        </div>
                    </div>
                </div>
            </div>
            <p className="pt-4 text-center text-sm pb-5">
                Copyright {new Date().getFullYear()} © <a href=" ">HADANA</a>. All Right Reserved.
            </p>
        </footer>
    )
}
